...
urlpatterns = [
    ...
    path('kjsomaiyacollegeofengineeringandinformationtechnologyteachers-fullmessages/chat/username=<name>', views.fullmessages, name='kjsomaiyacollegeofengineeringandinformationtechnologyteachers-fullmessages/chat/username=<name>'),
