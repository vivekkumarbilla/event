...
def totxtall(request):
	if request.method == "POST":
		...
		response.write("To "+timet+"<br />")
		response.write(" ""<br />")
		response.write("Description : "+desc+"<br />")
		response.write("Presenter : "+pre+"\t")
		response.write(", "+pred+"<br />")
		response.write(" ""<br />")
		response.write("Organizer : "+org+"<br />")
		response.write("Department : "+dep+"<br />")
		response.write(" ""<br />")
		response.write("Registrations from "+regf+" "+regt+"<br />")
		response.write(" ""<br />")
		response.write("Faculty Co-ordinators : "+faccod1+" ")
		response.write(" "+faccod2+" ")
		response.write(" "+faccod3+"<br />")
		response.write("Conveners : "+conv1+" ")
		response.write(""+conv2+"<br />")
		response.write("Contacts : "+cont1+" ")
		response.write(""+cont2+"<br />")
